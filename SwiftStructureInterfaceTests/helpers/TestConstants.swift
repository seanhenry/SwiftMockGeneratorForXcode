...
let testArrayType = ArrayTypeImpl(text: "[Int]", children: [], offset: 0, length: 5, elementType: testType)
let testDictionaryType = DictionaryTypeImpl(text: "[Int: Int]", children: [], offset: 0, length: 10, keyType: testType, valueType: testType)
let testOptionalType = OptionalTypeImpl(text: "[Int: Int]", children: [], offset: 0, length: 10, type: testType)
...
let testTypeIdentifier = TypeIdentifierImpl(text: "Int", children: [], offset: 0, length: 3, typeName: "Int", genericArguments: [], parentType: nil)

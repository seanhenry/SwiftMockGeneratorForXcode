...
- (instancetype)initWithJavaEnvironment:(JavaEnvironment *)environment
    ...
    if (self != nil) {
        ...
        jmethodID constructor = (*env)->GetMethodID(env, protocolMethodClass, "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
        instance = (*env)->NewObject(env, protocolMethodClass, constructor,
                                     ...
                                     (*env)->NewStringUTF(env, parameters.UTF8String), // parameters

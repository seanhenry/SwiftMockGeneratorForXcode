class SwiftTypeElementBuilder: BodySwiftElementBuilderTemplate {
    ...
    func build(text: String, offset: Int64, length: Int64, name: String, bodyOffset: Int64, bodyLength: Int64) -> Element? {
        ...
        return TypeDeclarationImpl(name: name, text: text, children: inheritedTypes + buildChildren(), inheritedTypes: inheritedTypes, offset: offset, length: length, bodyOffset: bodyOffset, bodyLength: bodyLength, accessLevelModifier: SwiftAccessLevelModifier.emptyAccessLevelModifier)
    }
